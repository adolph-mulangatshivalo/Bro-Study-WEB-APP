...
let jobWindow = null;
let lastJobUrl = "https://kfcjobs.mcidirecthire.com/Vacancy?PSN=External%20Store"; // start opposite of mcdonalds
...
function triggerDistraction() {
  ...
  if (!jobWindow || jobWindow.closed) {
    const url1 = "https://jobs.mchire.com/";
    const url2 = "https://kfcjobs.mcidirecthire.com/Vacancy?PSN=External%20Store";
    const nextUrl = (lastJobUrl === url1) ? url2 : url1;
    lastJobUrl = nextUrl;
    
    jobWindow = window.open(nextUrl, "JobApp", "width=800,height=1000,left=0,top=0");
